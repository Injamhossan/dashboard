...
const Reminders = () => {
  return (
    <div className="bg-white p-6 rounded-[24px] border border-gray-100 flex flex-col justify-between h-full w-full shadow-sm">
      ...
      <button className="flex items-center justify-center gap-2 w-full bg-gradient-to-r from-[#1f7a4e] to-[#112F24] text-white py-3.5 rounded-[34px] text-[14px] font-semibold mt-auto hover:bg-[#0a1e17] transition-all group">
